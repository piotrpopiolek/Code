...
public class TextFileTest
{
   ...
   /**
    * Zapisuje dane wszystkich obiekt�w klasy Employee
    * umieszczonych w tablicy
    * do obiektu klasy PrintWriter
    * @param employees tablica obiekt�w klasy Employee
   ...
   /**
    * Wczytuje tablic� obiekt�w klasy Employee
    * @param in obiekt klasy Scanner
    * @return tablica obiekt�w klasy Employee
    */
