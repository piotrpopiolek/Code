...
public class QueryTest
{
   ...
   /**
    * Prosi u¿yutkownika o wprowadzenie ³añcucha
    * @param prompt ³añcuch zachêty
    * @param options opcje, z których mo¿e wybieraæ u¿ytkownik
